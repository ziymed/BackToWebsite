...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_BackToWebsiteSettingsModal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/BackToWebsiteSettingsModal */ "./src/admin/components/BackToWebsiteSettingsModal.js");

/* harmony default export */ __webpack_exports__["default"] = ({
  'backtowebsite/components/BackToWebsiteSettingsModal': _components_BackToWebsiteSettingsModal__WEBPACK_IMPORTED_MODULE_0__["default"]
});

/***/ }),

/***/ "./src/admin/components/BackToWebsiteSettingsModal.js":
/*!************************************************************!*\
  !*** ./src/admin/components/BackToWebsiteSettingsModal.js ***!
  \************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return BackToWebsiteSettingsModal; });
...
var BackToWebsiteSettingsModal =
/*#__PURE__*/
function (_SettingsModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(BackToWebsiteSettingsModal, _SettingsModal);

  function BackToWebsiteSettingsModal() {
    return _SettingsModal.apply(this, arguments) || this;
  }

  var _proto = BackToWebsiteSettingsModal.prototype;
  ...
  _proto.form = function form() {
    ...
    }, m("label", null, app.translator.trans('backtowebsite.admin.settings.backto_url_label')), m("input", {
      className: "FormControl",
      bidi: this.setting('ziymed-backtowebsite.backto_url')
    }))];
  };

  return BackToWebsiteSettingsModal;
...
/* harmony import */ var _components_BackToWebsiteSettingsModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/BackToWebsiteSettingsModal */ "./src/admin/components/BackToWebsiteSettingsModal.js");
...
flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.initializers.add('ziymed-backtowebsite', function () {
  flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.extensionSettings['ziymed-backtowebsite'] = function () {
    return flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.modal.show(new _components_BackToWebsiteSettingsModal__WEBPACK_IMPORTED_MODULE_3__["default"]());
  };
}); // Expose compat API
